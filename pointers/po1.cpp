...
int main () {
	...
	//un puntero le asignamos una variable array, simplemente le asigno sin la posicion de memoria

	p = new int[10]; // crea un array de 5 enteros,en heap, es el equivalente al malloc, le estamos pidiendo memoria al heap
